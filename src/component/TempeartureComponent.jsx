    ...
    <div className="converter">
      <div className="cover">
        ...
        <div className="input-group">
          <input className='convert' type="text" value={fahrenheit} onChange={handleFahrenheitChange} />
          <span className='unit'>{unit === 'F' ? 'Fahrenheit' : 'Celsius'}</span>
        </div>
        {/* Button to switch between Fahrenheit and Celsius */}
        <button onClick={handleSwitch} className="switch-btn">
          <img width={30} height={30} src={isDarkTheme ? "https://cdn-icons-png.flaticon.com/128/10771/10771426.png":"https://cdn-icons-png.flaticon.com/128/10772/10772014.png"} alt="Switch" />
        </button>
        {/* Celsius input */}
        <div className="input-group">
          <input className='convert' type="text" value={celsius} onChange={handleCelsiusChange} />
          <span className='unit'>{unit === 'F' ? 'Celsius' : 'Fahrenheit'}</span>
        </div>
      </div>
    </div>
  );
